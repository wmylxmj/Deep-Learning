# -*- coding: utf-8 -*-
"""
Created on Tue Aug 28 19:32:01 2018
...
class DeepNeuralNetwork:
    ...
    def Backward_Propagation(self, Y):
        ...
        dAL = - (np.divide(Y, self.AL) - np.divide(1 - Y, np.float64(1 - self.AL)))
...
a = DeepNeuralNetwork
a.__init__(n, [train_X.shape[0], 20, 3, 1])
a.Train_Dropout(n, train_X, train_Y, [0.86, 0.86], learning_rate = 0.05, iterations = 30000, print_cost = True)
plt.title("Model without regularization")
axes = plt.gca()
axes.set_xlim([-0.75,0.40])
axes.set_ylim([-0.75,0.65])
plot_decision_boundary(lambda x: a.Predict(a, x.T), train_X, np.squeeze(train_Y))
print(a.grads['dA3'].shape)
print(a.grads['dA2'].shape)
print(a.grads['dA1'].shape)
print(a.grads['dA0'].shape)
print(a.grads['dW3'].shape)
print(a.grads['dW2'].shape)
print(a.grads['dW1'].shape)
