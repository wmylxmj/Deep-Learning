# -*- coding: utf-8 -*-
"""
Created on Tue Aug 28 18:56:34 2018
...
a = DeepNeuralNetwork
a.__init__(n, [train_X.shape[0], 50, 7, 1])
a.Train(a, train_X, train_Y, iterations = 30000, learning_rate = 0.1, print_cost = True)
