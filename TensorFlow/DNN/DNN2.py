# -*- coding: utf-8 -*-
"""
Created on Mon Sep 10 17:14:30 2018
...
class DeepNeuralNetwork():
    ...
    def Train(self, X_train, Y_train, iterations = 20, learning_rate = 0.0001, minibatch_size = 32, print_cost = True):
        ...
        with tf.Session() as sess:
            ...
            for i in range(1, iterations + 1):
                ...
                if i % self.iteration_unit == 0:
                    ...
                    pass
                saver.save(sess, self.checkpoints_save_dir + "model", global_step = i)
                pass
...
n = DeepNeuralNetwork("DNN1", [12288, 25, 12, 6])
print(n.checkpoints_save_dir)
n.iteration_unit = 1
