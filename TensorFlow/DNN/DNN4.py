# -*- coding: utf-8 -*-
"""
Created on Tue Sep 11 19:40:54 2018
...
'''
n = DeepNeuralNetwork("DNN2", [12288, 25, 12, 6]) 

n.iteration_unit = 10
n.Train(X_train, Y_train, iterations = 2000, learning_rate = 0.0001, train_name = "train_3", print_cost = True) 
'''
#tf.reset_default_graph()
